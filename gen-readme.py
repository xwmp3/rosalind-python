...
if __name__ == '__main__':
    ...
    md.write('<img src="https://s2.loli.net/2022/07/04/rD5a9fk21iVJ7KG.jpg" alt="drawing" width="450"/>\n\n') # header image
    md.write('# rosalind-python\n\n')  # repo title
    md.write('Solution in Python for problems in [ROSALIND](https://rosalind.info/)\n\n') # description
    
    basedir = './'
    dirnames = ['bioinfomatics-stronghold', 'bioinfomatics-armory', 'bioinfomatics-textbook-track', 'algorithmic-heights']
    locnames = ['Bioinfomatics Stronghold', 'Bioinfomatics Armory', 'Bioinfomatics Textbook Track', 'Algorithmic Heights']
